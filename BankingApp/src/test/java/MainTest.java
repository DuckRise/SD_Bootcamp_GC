...
public class MainTest {
    ...
    public void testAddAccount() {
        Main atm = new Main();
        BankAccount account = new SmallBusinessAccount("Small Business Account", "1", 0);
    ...
    public void testFindAccount() {
        ...
        BankAccount account1 =
                new SmallBusinessAccount("Small Business Account", "1", 0);
        BankAccount account2 = new CommunityAccount("Community Account", "2", 0);
